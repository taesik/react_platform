...
export const SearchResultKeywordNews = (props: IMainProps) => {
    ...
    <>
      ...
      <div className="container">
        <div className="sub-top-list">
          <div className="row">
            <KeywordSbcrbList keywords={["#word1","#word2","#word3","#word4"]}/>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <div className="cont">
          ...
          <NewsList myKeywords={props.myKeyword} newsList={[
            {
              id : "id",
              title : "title",
              content : "content",
...
export default connect(mapStateToProps, mapDispatchToProps)(SearchResultKeywordNews);
